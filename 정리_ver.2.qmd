...
```{python}
#안전도 점수
df['score_가로등'] = (df['근처 가로등수'] / df['근처 가로등수'].max()) * weights['가로등']
df['score_CCTV'] = (df['근처 CCTV개수'] / df['근처 CCTV개수'].max()) * weights['CCTV']
df['score_광원'] = (df['광원 등급'] / df['광원 등급'].max()) * weights['광원']
```
